...
class Explorer(AbstAgent):
    ...
    def __init__(self, env, config_file, resc):
        ...
        """
        print("Explorer instance created")
    ...
    def deliberate(self) -> bool:
        ...
        #print("Deliberate method called")

        time_tolerance = 2* self.COST_DIAG * Explorer.MAX_DIFFICULTY + self.COST_READ
        # print("Time:", self.walk_time)
        # print("Remaining time:", self.get_rtime() - time_tolerance)
